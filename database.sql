...
CREATE TABLE `products_bought`  (
  ...
  `time_length` time NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
BEGIN;
INSERT INTO `users` (`id`, `username`, `password`, `account_type`) VALUES (1, 'test', '50c0152c2952082aeaf427885a2f617d67cf6de183a8816c0955ea5b875a216b', 1), (13, 'test3', 'b819462a81cd04dbabfe87db6bb30678baaaa74cc078a6d219b13aeb4c579ece', 1), (14, 'test4', 'eefefd2b42ee468b46da4597e68fd6f69d89b0caeca05ca96b5014abef6b5cdd', 1), (15, 'test5', '2e0b8d61fa2a6959d254b6ff5d0fb512249329097336a35568089933b49abdde', 1), (16, 'test6 ', 'e81dfe69841ad2f7b5790b63e998f0febaf3b29acd732881975130761b98e2c7', 1), (2, 'test2', '50c0152c2952082aeaf427885a2f617d67cf6de183a8816c0955ea5b875a216b', 2);
COMMIT;
